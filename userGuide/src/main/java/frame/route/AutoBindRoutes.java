...
import frame.kit.ClassSearcher;
...
public class AutoBindRoutes extends Routes {
	...
	public void config() {
		List<Class<? extends Controller>> controllerClasses = (List<Class<? extends Controller>>) ClassSearcher.of(Controller.class).includeAllJarsInLib(includeAllJarsInLib).injars(includeJars).search();
	...
	private String controllerKey(Class<Controller> clazz) {
		Preconditions.checkArgument(clazz.getSimpleName().endsWith(suffix), " does not has a @ControllerBind annotation and it's name is not end with " + suffix);
